defmodule WspomWeb.CoreComponents do
  ...
  def input(%{type: "textarea"} = assigns) do
    ...
    <div phx-feedback-for={@name}>
      ...
      <textarea
        ...
        name={@name}
        class={[
          @class || "mt-2 block w-full rounded-lg focus:ring-0 sm:text-sm sm:leading-6 min-h-[6rem] phx-no-feedback:border-zinc-300 phx-no-feedback:focus:border-zinc-400",
          @class_text || "text-zinc-900",
  ...
  def list(assigns) do
    ~H"""
    <div class="sm:w-full md:w-3/4 mt-14">
